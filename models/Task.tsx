...
export const defaultTasks: Task[] = [
    {
        ...
        about: "Consistent sleep has two parts: 8 hours every night, and a consistent bedtime and wakeup time. Getting around 8 hours of sleep is generally recommended for optimal health. It is beneficial to establish a very consistent sleep schedule - once you settle into a routine sleep schedule, you'll find yourself feeling better every day. This is the most important daily task, because without proper sleep, your immune system is compromised, your brain isn't operating at maximum efficiency, your digestive system suffers, and a variety of other problems.",
        order: 0,
    },
    {
        name: "Diet",
