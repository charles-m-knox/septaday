...
export default function TasksScreen() {
  const defaultTasks: Task[] = [
    {
      name: "Consistent Sleep", completed: false,
    ...
    {
      name: "Dental & Physical Hygiene", completed: false,
    ...
    {
      name: "Disconnect 30 minutes (walk)", completed: false,
      id: "79e2ba1d-734b-4530-aa86-2a20d4acb4c1",
      about: ""
    },
    {
      name: "Hour of Focus", completed: false,
